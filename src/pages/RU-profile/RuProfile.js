...
import doubleCircle from '../../assets/recordcircle.png';
  ...
  return (
    <div className=' ru-profile p-3 pt-4 '>
      <div className='d-flex flex-column '>
        <div className='mb-4'>
          <h4 className='color-blue'>RU Profile</h4>
          <p  style={{ fontWeight: "400" }}>Lorem ipsum is simply a dummy text</p>
        </div>

        <div className='row bgc-white py-4 rounded' >
          <div className='col-5'><p>RU Profle: Template Nmae RU/DU-12</p></div>
          <div className='col-7'><p>Arthena pe: Macro</p></div>
        </div>

        <div className='row mt-3 bgc-white rounded pb-4'>
          <div className='col-12'>
            <h4 className='py-3' >RU Profile</h4>
            <div className='container-fluid'>
              <div className='row rounded cl-gap'>
                ...
                <div className='col rounded bgc-white py-3'>
                  <p>Site Sactorization</p>
